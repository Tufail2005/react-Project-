...
const PlayVideo = () => {
  ...
  const fetchOtherData = async () => {
    if (!apiData) return; // safety check
    ...
    <div className="play-video">
      ...
      <div className="play-video-info">
        ...
        <div>
          <span>
            <img src={like} alt="" />{" "}
            {apiData ? value_converter(apiData.statistics.likeCount) : 25}
          </span>
          <span>
            <img src={dislike} alt="" />
          </span>
      ...
      <div className="publisher">
        ...
        <div>
          <p>
            {" "}
            {apiData ? apiData.snippet.channelTitle : "Channel Loading..."}
          </p>
          <span>
            {channelData
      ...
      <div className="vid-description">
        ...
        <hr />
        <h4>
          {apiData ? value_converter(apiData.statistics.commentCount) : "200"}{" "}
          Comments
        </h4>
